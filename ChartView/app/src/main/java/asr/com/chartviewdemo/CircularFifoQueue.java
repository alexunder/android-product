/*
 * This file is modified by Yoshi (yoshijava@gmail.com). Extracted from Apache Common Collections
 * If you only need a circular queue which is not built in standard Java, 
 * and you don't want the full set of Apache Common Collections, then this is what you may need
*/
